...
class DeformableTransformer(nn.Module):
    def __init__(self, d_model=256, nhead=8,
                 ...
                 checkpoint_enc_ffn=False, checkpoint_dec_ffn=False, look_forward_twice=False):
        super().__init__()
    ...
    def forward(self, srcs, masks, pos_embeds, query_embed=None, pre_reference=None, pre_tgt=None, memory=None,
        ...
        if pre_reference is not None:
            if self.two_stage and self.training:
                output_memory, output_proposals = self.gen_encoder_output_proposals(memory, mask_flatten,
                                                                                    spatial_shapes)
            ...
            if self.two_stage:
                ...
                topk = self.two_stage_num_proposals  # 500, 1000 / 5, 100->200
        ...
        for lid, layer in enumerate(self.layers):
            ...
            if self.return_intermediate:
                ...
                intermediate_reference_points.append(
                    ...
                    reference_points
                    if self.look_forward_twice and self.bbox_embed is not None
