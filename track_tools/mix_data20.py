...
cd mix20
ln -s ../mot20/train mot_train
ln -s ../crowdhuman/CrowdHuman_train crowdhuman_train
cd ..
"""

mot_json = json.load(open('mot20/annotations/train.json', 'r'))
...
json.dump(mix_json, open('mix20/annotations/train.json', 'w'))

mot_json = json.load(open('mot20/annotations/train_half.json', 'r'))
...
mix_json['videos'] = video_list
mix_json['categories'] = category_list
json.dump(mix_json, open('mix20/annotations/train_half.json', 'w'))
