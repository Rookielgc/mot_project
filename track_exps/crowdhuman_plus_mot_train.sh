...
python3 main_track.py  --output_dir ./output_HR --dataset_file mix --coco_path mix --batch_size 1 --resume crowdhuman_final.pth --with_box_refine --num_queries 500  --epochs 20 --lr_drop 10
